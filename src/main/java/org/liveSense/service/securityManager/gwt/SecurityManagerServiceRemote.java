 ...
 * @author robson
 */
public interface SecurityManagerServiceRemote extends RemoteService {
	...
	Map<String, AccessRights> getDeclaredAccessRights(String absPath) throws InternalException, AccessDeniedException;
