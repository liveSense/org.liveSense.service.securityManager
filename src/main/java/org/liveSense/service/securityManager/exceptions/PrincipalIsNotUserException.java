...
public class PrincipalIsNotUserException extends Exception implements Serializable {
	...
	public PrincipalIsNotUserException(String msg) {
		super(msg);
		this.msg = msg;
	}

	public PrincipalIsNotUserException(Throwable cause) {
		super(cause);
		this.msg = cause.getMessage();
	}

	public PrincipalIsNotUserException(String msg, Throwable cause) {
		super(msg, cause);
		this.msg = msg;
	}
