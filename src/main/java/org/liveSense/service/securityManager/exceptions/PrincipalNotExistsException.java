...
public class PrincipalNotExistsException extends Exception implements Serializable {
	...
	public PrincipalNotExistsException(String msg) {
		super(msg);
		this.msg = msg;
	}

	public PrincipalNotExistsException(Throwable cause) {
		super(cause);
		this.msg = cause.getMessage();
	}

	public PrincipalNotExistsException(String msg, Throwable cause) {
		super(msg, cause);
		this.msg = msg;
	}
